...
RSpec.describe CommentsController, type: :controller do
  let(:my_user) {User.create!(name: "Benedict Miller", email: "benedict@email.com", password: "password")}
  ...
  let(:my_comment) {my_post.comments.create!(body: "Comment Body", user: my_user)}
  ...
  context "member user doing CRUD on a comment they don't own" do
    ...
    describe "POST create" do
      it "increases the count of comments by 1" do
