...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST #create" do
    it "increases questions by 1" do
    ...
    it "assigns the new question to @question" do
      post :create,
      question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resloved:false}
      expect(assigns(:question)).to eq Question.last
    end

    it "redirects to the new question" do
      post :create,
      question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved:false}
  ...
  describe "GET #edit" do
    ...
    it "assigns my_question to @question to be updated" do
      get :edit, {id: my_question.id}
