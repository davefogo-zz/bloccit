...
RSpec.describe TopicsController, type: :controller do
  ...
  context "member user" do
    before do
      user = User.create!(name: "Venom Snake", email: "venom@email.com", password: "password", role: :member)
      create_session(user)
    end
    ...
    describe "GET #index" do
      ...
      it "assigs Topic.all to topic" do
        get :index
        expect(assigns(:topics)).to eq([my_topic])
      end
    end
  ...
  context "admin user" do
    before do
      user = User.create!(name: "Kazuhira Miller", email: "kazuhira@email.com", password: "password", role: :admin)
      create_session(user)
    end
  ...
  context "mod user" do
    before do
      mod_user = User.create!(name: "Shalashaska Ocelot", email: "shalashaska@email.com", password: "password", role: :moderator)
    ...
    describe "PUT update" do
      ...
      it "redirects to the updated topic" do
        ...
        post :update, id: my_topic.id, topic: {name: new_name, description: new_description}
        expect(response).to redirect_to(my_topic)
      end
    end
