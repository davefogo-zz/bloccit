...
RSpec.describe PostsController, type: :controller do
  ...
  context "member user does CRUD on a non-authored post" do
    before do
  ...
  context "member user does CRUD on a post they authored" do
    before do
    ...
    describe "POST create" do
      ...
      it "assigns the new post to @post" do
        post :create, topic_id: my_post.id, post: {title: RandomData.random_sentence, body: RandomData.random_paragraph}
        expect(assigns(:post)).to eq(Post.last)
      end
    ...
    describe "GET edit" do
      ...
      it "assigns the post to be updated to @post" do
        ...
        expect(post_instance.title).to eq(new_title)
        expect(post_instance.body).to eq(new_body)
      end
    end
  ...
  context "admin user does CRUD on a post they didn't author" do
    before do
      other_user.admin!
      create_session(other_user)
    end
    ...
    describe "GET edit" do
      ...
      it "assigs the post to be updated to @post" do
        get :edit, topic_id: my_topic.id, id: my_post.id
        post_instance = assigns(:post)
  ...
  context "mod user does CRUD on a post they didn't author" do
    before do
      mod_user = (User.create!(name: "James Burger", email: "james@email.com", password: "password", role: :moderator))
